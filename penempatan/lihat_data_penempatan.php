            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php foreach ($listPenempatan as $penempatan) : ?>
                        <tr>
                            <td>
                                <?= $penempatan['nama_barang'] ?>
                            </td>
                            <td>
                                <?= $penempatan['tahun_perolehan'] ?>
                            </td>
                            <td>
                                <?= $penempatan['grup'] ?>
                            </td>
                            ...
                            <td>
                                <?= $penempatan['sub_kelas'] ?>
                            </td>
                            <td>
                                <?= $penempatan['nomor_urut'] ?>
                            </td>
                            <td>
                                <?= $penempatan['kode_aset'] ?>
                            </td>
                            <td>
                                <?= $penempatan['qr_code'] ?>
                            </td>
                            <td>
                                <?= $penempatan['kode_telkom'] ?>
                            </td>
                            <td>
                                <?= $penempatan['serial_number'] ?>
                            </td>
                            <td>
                                <img src="foto/<?= $penempatan['foto'] ?>" alt="<?= $penempatan['foto'] ?>">
                            </td>
...
<script>
    ...
    Swal.fire({
        title: 'Berhasil',
        html: `Data penempatan <b><?php echo htmlspecialchars($_GET['nama'], ENT_QUOTES, 'UTF-8'); ?></b> berhasil dihapus`,
        icon: 'success'
    });
    <?php endif; ?>
</script>
